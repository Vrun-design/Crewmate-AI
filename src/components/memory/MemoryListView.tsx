...
export function MemoryListView({nodes}: MemoryListViewProps): React.ReactNode {
  ...
  return (
    <div className="flex-1 p-4 md:p-6 overflow-y-auto">
      ...
      <Drawer isOpen={isDrawerOpen} onClose={() => setIsDrawerOpen(false)} title={getMemoryDrawerTitle(drawerMode)}>
        <MemoryDrawerContent mode={drawerMode} selectedNode={selectedNode} onClose={() => setIsDrawerOpen(false)} />
      </Drawer>
