...
import { getAssistantTranscriptText } from './liveGatewayTranscript';
import { ingestLiveTurnMemory } from './memoryService';
import type { RuntimeSession } from './liveGatewayTypes';
import type { LiveServerMessage } from '@google/genai';

export function maybePersistTurnMemory(runtime: RuntimeSession): void {
...
export function syncAssistantTranscript(runtime: RuntimeSession): void {
...
export function handleInputTranscription(runtime: RuntimeSession, message: LiveServerMessage): void {
...
export function resetAssistantTurn(runtime: RuntimeSession): void {
...
export function handleInterruptedPlayback(runtime: RuntimeSession): void {
